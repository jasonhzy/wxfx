...
<div class="top_bar" style="-webkit-transform:translate3d(0,0,0)">
   <nav>
	...
	<li class="li3">
	<?php if(empty($lang['userinfo'])){?>
	<a href="<?php echo ADMIN_URL;?>user.php?act=apply"><label>申请分销</label></a>
	<?php }else{ ?>
	<a href="<?php echo ADMIN_URL;?>user.php?act=dailicenter"><label>我的分销</label></a>
	<?php
	}?>
	<span></span>
	</li>
