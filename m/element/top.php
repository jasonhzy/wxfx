<?php if($GLOBALS['LANG']['mubanid']>0){ ?>
<link type="text/css" rel="stylesheet" href="<?php echo ADMIN_URL;?>css/theme/style<?php echo $GLOBALS['LANG']['mubanid'];?>.css?v=3" media="all" />
<?php } ?>
<div id="home">
	<div id="header">
