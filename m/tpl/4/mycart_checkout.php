		   ...
		   ?>
			...
			<tr>
				...
				<p style="padding-left:10px; padding-right:36px; position:relative; line-height:18px;">
					...
					<?php if(!empty($row['buy_more_best'])){echo '<br />该商品实行<font style="color:#FE0000;font-weight:bold">['.$row['buy_more_best'].']</font>促销活动，欢迎订购！';}?><span style="padding:2px 5px 2px 5px; color:#FF0000; cursor:pointer; position:absolute; right:1px; top:-4px; z-index:22; background:#fafafa; border:1px solid #ededed;border-radius:5px;" class="delcartid" id="<?php echo $k;?>">删除</span></p>
...
<!--			<p style="height:20px; line-height:20px;">
			...
			&nbsp;&nbsp;
			 <a href="javascript:;" onclick="return ajax_clear();" style="display:block;background:#3083CE;cursor:pointer;width:110px; height:30px; line-height:30px; font-size:18px; color:#FFF; font-weight:bold; text-align:center; float:left; margin-left:10px">清空购物车</a>
			</p>
	  </div>
	</form>
	</div>
