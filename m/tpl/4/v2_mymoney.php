...
.dailicenter li{ position:relative; height:40px; line-height:40px; background:#f8f8f8; border-bottom:1px solid #dcd9d8; text-align:center}
...
<div id="main" style="min-height:300px;margin-bottom:20px;">
	<ul class="dailicenter">
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=monrydeial&t=1';?>"><i></i>未付款订单佣金<span><?php echo !empty($rt['pay1']) ? $rt['pay1'] : '0.00';?>元</span></a>
		</li>
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=monrydeial&t=2';?>"><i></i>已付款订单佣金<span><?php echo !empty($rt['pay2']) ? $rt['pay2'] : '0.00';?>元</span></a>
		</li>
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=monrydeial&t=3';?>"><i></i>已收货订单佣金<span><?php echo !empty($rt['pay3']) ? $rt['pay3'] : '0.00';?>元</span></a>
		</li>
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=monrydeial&t=3';?>"><i></i>已取消作废佣金<span><?php echo !empty($rt['pay4']) ? $rt['pay4'] : '0.00';?>元</span></a>
		</li>
		<li style="border-bottom:none">
		<a href="<?php echo ADMIN_URL.'daili.php?act=monrydeial&t=3';?>"><i></i>审核通过的佣金<span><?php echo !empty($rt['pay5']) ? $rt['pay5'] : '0.00';?>元</span></a>
		</li>
	</ul>
</div>
