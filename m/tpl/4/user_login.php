...
<div id="main" style="padding:10px; min-height:300px">
	<form id="LOGIN" name="LOGIN" method="post" action="">
			...
			<tr>
				<td width="100%" align="center"><input placeholder="为手机号码" type="text" name="username" style="width:98%; height:30px; line-height:30px;" class="pw pw2"/></td>
			</tr>
			<tr>
				<th align="left">用户密码：</th>
			</tr>
			<tr>
				<td width="100%" align="center"><input placeholder="微信端设置密码" type="password" name="password" style="width:98%; height:30px; line-height:30px;" class="pw pw2"/></td>
			</tr>
