...
.gonglist{  border:1px solid #d1d1d1; border-bottom:none; overflow:hidden}
...
.gonglist li.uli2 a{} 
.gonglist li p{}
.gonglist li p i{ background-size:80%;list-style:decimal; width:20px; height:44px; float:left; margin-left:7%}
...
<!--	<div data-role="navbar" class="ui-navbar ui-mini" role="navigation">
		<ul class="meTopNav ui-grid-b">
		  <li class="ui-block-a"><a href="<?php echo ADMIN_URL;?>user.php?act=mypoints" data-theme="d" data-ajax="false" data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="span" data-inline="true" class="ui-btn ui-btn-inline ui-btn-up-d"><span class="ui-btn-inner"><span class="ui-btn-text"><span class="meTopNavNumber"><?php echo empty($rt['userinfo']['points']) ? '0' : $rt['userinfo']['points'];?></span><br>
			我的积分</span></span></a></li>
		  <li class="ui-block-b"><a href="<?php echo ADMIN_URL.'user.php?act=myshare';?>" data-theme="d" data-ajax="false" data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="span" data-inline="true" class="ui-btn ui-btn-up-d ui-btn-inline"><span class="ui-btn-inner"><span class="ui-btn-text"><span class="meTopNavNumber"><?php echo empty($rt['userinfo']['share_ucount']) ? '0' : $rt['userinfo']['share_ucount'];?></span><br>
			我的邀请</span></span></a></li>
		  <li class="ui-block-c"><a href="<?php echo ADMIN_URL.'user.php?act=myuser';?>" data-theme="d" data-ajax="false" data-corners="false" data-shadow="false" data-iconshadow="true" data-wrapperels="span" data-inline="true" class="ui-btn ui-btn-up-d ui-btn-inline"><span class="ui-btn-inner"><span class="ui-btn-text"><span class="meTopNavNumber"><?php echo empty($rt['userinfo']['guanzhu_ucount']) ? '0' : $rt['userinfo']['guanzhu_ucount'];?></span><br>
			我的好友</span></span></a></li>
		</ul>
	 </div>-->
  	...
  	<div data-role="content" class="ui-content" role="main">
		...
		<ul class="gonglist">
			...
			<li class="uli10"><p><a href="<?php echo ADMIN_URL;?>user.php?act=mygift"><i></i>赠送礼包</a></p></li>
