...
<div id="main" style="min-height:300px;margin-bottom:20px;">
	...
	<?php } ?>
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=myuser&t=1';?>"><i></i>我的一级客户<span><?php echo empty($rt['zcount1']) ? '0' : $rt['zcount1'];?>人</span></a>
		</li>
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=myuser&t=2';?>"><i></i>我的二级客户<span><?php echo empty($rt['zcount2']) ? '0' : $rt['zcount2'];?>人</span></a>
		</li>
		<li>
		<a href="<?php echo ADMIN_URL.'daili.php?act=myuser&t=3';?>"><i></i>我的三级客户<span><?php echo empty($rt['zcount3']) ? '0' : $rt['zcount3'];?>人</span></a>
		</li>
	</ul>
</div>
