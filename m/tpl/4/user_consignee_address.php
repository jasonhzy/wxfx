...
<div id="main" style="padding:5px; min-height:300px">
	 <?php if(!empty($rt['userress'])){ 
		...
		?>	
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-radius: 14px;border:1px solid #e5e5e5;padding:10px; margin:0px; line-height:24px; background-color:#fafafa; margin-bottom:7px;">
			  <tr>
  ...
  <div class="add">
  	<div class="usertitle">添加收货地址</div>
