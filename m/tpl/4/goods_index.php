<link type="text/css" rel="stylesheet" href="<?php echo ADMIN_URL;?>css/theme/style<?php echo $mubanid;?>.css" media="all" />
...
<div id="main">
	<div class="mainhead" style="margin:5px; border:1px solid #ededed;border-radius:5px; background:#FFF">
					...
					<ul>
						<li class="good rate-checked">
							<label for="rate-good-841112656649579">
								<input checked="checked" name="ranks" type="radio" value="1" class="good-rate">
						...
						<li class="normal">
							<label for="rate-normal-841112656649579">
								<input name="ranks" type="radio" value="0" class="noraml-rate">
...
<script type="text/javascript">
  ...
  function _report(a,c){
    ...
    function ajax_submit_mes(){
	  ...
	  createwindow();
	  goods.ranks = $('input[name="ranks"]').val();
