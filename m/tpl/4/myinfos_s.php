...
<div id="main" style="padding:5px; min-height:300px">
	 <?php if(!empty($rt['userress'])){ 
		...
		?>	
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-radius:5px;border:1px solid #e5e5e5;padding:10px; margin:0px; line-height:24px; background-color:#fafafa; margin-bottom:7px; margin-top:10px;">
			  <tr>
  ...
  <div class="add">
	...
	<table width="100%" border="0" style="line-height:24px;padding:10px;background:#f5f5f5; border:1px solid #d1d1d1;border-radius:5px;" cellpadding="0" cellspacing="0">
	  <tr>
